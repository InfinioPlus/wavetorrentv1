...
namespace WaveTorrentV1.src.Client.Messages
{
    class Cancel
    {
        ...
        public Cancel(int piece_index, int offset, int length)
        {
            ...
            if (header.Length != 4)
            {
                throw new CancelException("message header different of 4 bytes length");
            }
            ...
            if (index.Length != 4)
            {
                throw new CancelException("cant convert piece index to 4 byte array");
            }
            ...
            if (off.Length != 4)
            {
                throw new CancelException("cant convert offset to 4 byte array");
            }
            ...
            if (len.Length != 4)
            {
                throw new CancelException("cant convert requested length to 4 byte array");
            }
